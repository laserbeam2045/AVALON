...
{
  switch (style) {
    case (CS_TYPE)TWO_WAY       : this->twoWay[color]++; break;
    case (CS_TYPE)BREAK_THROUGH : this->breakThrough[color]++; break;
...
{
  switch (style) {
    case (CS_TYPE)TWO_WAY       : return this->twoWay[color];
    case (CS_TYPE)BREAK_THROUGH : return this->breakThrough[color];
